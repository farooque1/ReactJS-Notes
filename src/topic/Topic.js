...
<div>
    ...
    <Link to="/Funcmp">React app</Link>
    <Link to="/Clscmp">Class app</Link>
...
<div class="list-group mt-5">
  ...
  <Link to="/" class="list-group-item list-group-item-action" aria-current="true">
    ...
    <h6 class="mb-1"> How To create React App <i class="fa fa-arrow-right fa-lg"></i> </h6> 

    </div>
  </Link>
  <Link to="/funcmp" class="list-group-item list-group-item-action" aria-current="true">
    <div class="d-flex w-100">
      <h6 class="mb-1"> How To create Function component <i class="fa fa-arrow-right fa-lg"></i></h6>
    </div>
  </Link>
  <Link to="/clscmp" class="list-group-item list-group-item-action" aria-current="true">
    <div class="d-flex w-100">
    <h6 class="mb-1"> How To create Class component <i class="fa fa-arrow-right fa-lg"></i></h6>
    </div>
  </Link>

  <Link to="/clscmp" class="list-group-item list-group-item-action" aria-current="true">
    <div class="d-flex w-100">
    <h6 class="mb-1"> How To create React DOM and Routes<i class="fa fa-arrow-right fa-lg"></i></h6>
    </div>
  </Link>
